...
@if($sub_categories != null && count($sub_categories) > 0)
						...
						<label class="col-lg-3 col-form-label">Customer Category  <span class="required">*</span></label>
						<div class="col-lg-9">
							<span id="load_customer_category">
							<select id="customer_category" name="customer_category" class="form-control" required>
